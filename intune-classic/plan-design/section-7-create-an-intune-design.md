...
-   Další informace o tom, jaká [zařízení Intune podporuje](/intune-classic/get-started/supported-mobile-devices-and-computers).
...
-   Přečtěte si další informace o [aplikacích pro iOS koupených přes program Volume Purchase Program pro firmy /intune-classic/deploy-use/manage-ios-apps-you-purchased-through-a-volume-purchase-program-with-microsoft-intune)).
