...
## [Plánování, návrh a implementace nasazení](plan-design/introduction.md)
...
## [Migrace](plan-design/intune-mdm-migration-guide.md)
### [Fáze 1: Příprava Intune pro MDM](plan-design/migration-phase1-prepare-intune-for-mobile-device-management.md)
#### [Základní nastavení](plan-design/migration-phase1-basic-setup.md)
#### [Konfigurace zásad pro správu zařízení a aplikací](plan-design/migration-phase1-configure-device-and-app-management-policies.md)
#### [Konfigurace zásad pro ochranu aplikací](plan-design/migration-phase1-configure-app-protection-policies.md)
#### [Speciální aspekty migrace](plan-design/migration-phase1-special-migration-considerations.md)
### [Fáze 2: Kampaň migrace](plan-design/migration-phase2-migration-campaign.md)
#### [Plán komunikace](plan-design/migration-phase2-communication-plan.md)
#### [Přijetí jednotky](plan-design/migration-phase2-drive-end-user-adoption-with-conditional-access.md)
#### [Typický cyklus migrace](plan-design/migration-phase2-typical-migration-cycle.md)
...
## [Co je nového v Azure Preview](/intune/whats-new?toc=/intune-classic/toc.json&bc=/enterprise-mobility/toc.json)
...
##### [Nastavení integrace aplikací Lookout a Intune](deploy-use/setup-your-lookout-mtd-subscription.md)
##### [Povolení aplikace Lookout v Intune](deploy-use/enable-lookout-mtd-connection.md)
##### [Nasazení aplikací k použití s aplikací Lookout](deploy-use/configure-deploy-lookout-for-work-app.md)
...
### [Činnost koncového uživatele pro Android s aplikacemi s podporou správy mobilních aplikací (MAM)](deploy-use/user-experience-for-mam-enabled-android-apps-with-microsoft-intune.md)
### [Činnost koncového uživatele pro iOS s aplikacemi s podporou správy mobilních aplikací (MAM)](deploy-use/user-experience-for-mam-enabled-ios-apps-with-microsoft-intune.md)
