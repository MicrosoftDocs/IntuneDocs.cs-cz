...
- [Kontrola požadovaných síťových adres URL a portů](../get-started/network-bandwidth-use.md)
- [Přidání a ověření názvu domény](../get-started/start-with-a-paid-subscription-to-microsoft-intune-step-2.md)
