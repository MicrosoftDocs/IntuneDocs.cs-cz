...
> [!IMPORTANT]
> Obsah na této stránce je nyní z velké části zastaralý, protože zásady Intune App Protection byly zcela migrovány na portál Azure Portal. Další informace o [zásadách Intune App Protection pro iOS na portálu Azure Portal](https://docs.microsoft.com/intune/app-protection-policy-settings-ios)
