...
4. Otevře se dialogové okno **Ověřit doménu** s hodnotami pro vytvoření záznamu TXT u poskytovatele hostingu DNS.
    ...
    > [!TIP]
    > Při provádění změn v poskytovateli hostingu DNS nezapomeňte vytvořit alias DNS /intune-classic/deploy-use/set-up-windows-phone-management-with-microsoft-intune).
