...
- Musíte použít [místní Exchange Connector s protokolem Exchange Active Sync](install-intune-on-premises-exchange-connector.md), který připojí Intune k místnímu Exchangi.
