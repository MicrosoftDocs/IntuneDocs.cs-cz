...
# <a name="use-an-intune-custom-profile-to-create-a-per-app-vpn-profile-for-android-devices-in-intune-azure-preview"></a>K vytvoření profilu VPN pro aplikaci pro zařízení s Androidem v Intune Azure Preview můžete použít vlastní profil Intune.
