---
title: "Vytvoření a nasazení zásad ochrany aplikací | Intune Azure Preview | Dokumentace Microsoftu"
...
**Pokud nepoužíváte služby Intune v programu Azure Portal Preview**, vysvětluje toto téma, [jak vytvořit zásady ochrany aplikací](https://docs.microsoft.com/en-us/intune/deploy-use/create-and-deploy-mobile-app-management-policies-with-microsoft-intune) v konzole Intune Classic.
...
- [Zásady pro iOS](ios-app-protection-policy-settings.md)
- [Zásady pro Android](android-app-protection-policy-settings.md)

## <a name="next-steps"></a>Další kroky
[Monitorování stavu dodržování předpisů a uživatele](monitor-app-protection-policies-with-microsoft-intune.md)
