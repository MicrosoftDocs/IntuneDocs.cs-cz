...
Tyto podrobné pokyny vám pomůžou nastavit zkušební verzi Intune a nakonfigurovat zásadu PIN kódu pro zařízení s iOS. Seznam dalších běžných úloh hodnocení služby Intune najdete v tématu [Běžné úlohy hodnocení služby Microsoft Intune](common-microsoft-intune-evaluation-tasks.md)..
...
1.  Na počítači s Windows klikněte pravým tlačítkem myši na **Internet Explorer** (IE) a vyberte **Procházení InPrivate**..
...
5.  Uložte si informace uvedené na obrazovce a potom klikněte na **A jste připraveni dát se do toho**..
...
2.  Povolte registraci zařízení s iOS. Tento proces vytvoří důvěryhodný certifikát mezi službou APNs (Apple Push Notification Service) a vaším předplatným Intune.
    ...
    2.  Klikněte na **Stáhnout žádost o certifikát služby APN**..
    ...
    12. Zadejte umístění souboru JSON a klikněte na **Uložit**..
        ...
        Pokud se stránka po pár sekundách automaticky nepřesměruje, klikněte na **Zrušit**..
