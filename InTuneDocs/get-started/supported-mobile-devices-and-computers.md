...
description: "Seznam podporovaných zařízení a prohlížečů, ve kterých jde spustit Intune"
keywords: 
author: nathbarn
ms.author: nathbarn
manager: angrobe
...
# <a name="supported-devices-and-web-browsers-for-intune"></a>Podporovaná zařízení a webové prohlížeče pro Intune

Jako správce Intune můžete spravovat celou řadu zařízení z webového prohlížeče. Toto téma obsahuje:

- [Seznamy podporovaných platforem zařízení](#intune-supported-devices)
...
>[&larr; **Předpoklady**](what-to-know-before-you-start-microsoft-intune.md)     [**Práce v síti** &rarr;](network-bandwidth-use.md)  
