...
-   Přečtěte si další informace o tom, [jak nakonfigurovat poskytovatele MAM u Intune](https://docs.microsoft.com/intune/deploy-use/get-ready-to-configure-app-protection-policies-for-windows-10).
