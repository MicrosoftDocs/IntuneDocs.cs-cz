...
Nasměrujte uživatele na článek [Registrace zařízení s Androidem v Intune](/Intune/EndUser/enroll-your-device-in-intune-android), kde najdou další informace.
...
### <a name="how-to-explain-this-to-your-users"></a>Jak to vysvětlit uživatelům
Nasměrujte uživatele na článek [Odeslání protokolů správci IT e-mailem](/Intune/EndUser/send-logs-to-your-it-admin-by-email-android). Můžete jim nabídnout také článek [Odeslání protokolů správci IT kabelem](/Intune/EndUser/send-logs-to-your-it-admin-by-cable-android) pokud chcete, aby obě metody porovnali.
