---
title: "Endpoint Protection pro počítače s Windows | Microsoft Intune"
...
## Konfigurace Microsoft Intune Endpoint Protection
...
## Zadání nastavení služby Endpoint Protection
...
### Zadání nastavení ochrany v reálném čase
...
### Zadání nastavení plánu kontrol
...
### Zadat nastavení možností kontroly
...
### Výběr nastavení výchozích akcí
...
### Rozhodněte, jestli vybrat nastavení vyloučených souborů a složek
...
### Rozhodněte, jestli vybrat nastavení vyloučených procesů
...
### Rozhodněte, jestli vybrat nastavení vyloučených typů souborů
...
### Zadejte nastavení služby Microsoft Active Protection Service
...
## Výběr úloh správy pro službu Endpoint Protection
