...
# Konfigurace a nasazení zásad správy mobilních aplikací v konzole Microsoft Intune
...
Na rozdíl od jiných zásad Intune nenasazujte zásadu správy mobilních aplikací přímo. Místo toho přidružíte zásadu k aplikaci, kterou chcete omezit. Při nasazení a instalaci aplikace na zařízení začne platit zadané nastavení.

Pokud chcete u aplikace použít omezení, musí aplikace obsahovat sadu SDK (App Software Development Kit) Microsoftu. Tento typ aplikace se dá získat dvěma způsoby:
...
-   **Pokud chcete získat odkaz na aplikaci spravovanou zásadami** – V App Storu vyhledejte a poznamenejte si adresu URL aplikace spravované zásadami, kterou chcete nasadit.
...
-   **Vytvoření zabalené aplikace** – Použijte informace v tématech [Příprava aplikací pro iOS na správu mobilních aplikací nástrojem Microsoft Intune App Wrapping Tool](prepare-ios-apps-for-mobile-application-management-with-the-microsoft-intune-app-wrapping-tool.md) a [Příprava aplikací pro Android na správu mobilních aplikací nástrojem Microsoft Intune App Wrapping Tool](prepare-android-apps-for-mobile-application-management-with-the-microsoft-intune-app-wrapping-tool.md).
...
2.  U aplikací pro iOS vyberte **Spravovaná aplikace pro iOS z App Storu** v části **Vyberte, jakým způsobem má být tento software zpřístupněn pro zařízení**..
...
2.  Proveďte jeden z následujících kroků:
    ...
    -   Klikněte na **Všichni uživatelé** a potom dvakrát klikněte na uživatele, jejichž zařízení chcete prověřit. Na stránce **Vlastnosti uživatele** klikněte na **Zařízení** a dvakrát klikněte na zařízení, které chcete prověřit.

    -   Klikněte na **Všechna zařízení** &gt; **Všechna mobilní zařízení**. Na stránce **Vlastnosti skupiny zařízení** klikněte na **Zařízení** a dvakrát klikněte na zařízení, které chcete prověřit.
