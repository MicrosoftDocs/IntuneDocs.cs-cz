...
-    **Doména služby Active Directory**: Všechny servery uvedené v této části (s výjimkou proxy serveru webových aplikací) musí být připojené k vaší doméně služby Active Directory.

-  **Certifikační autorita** (CA): Certifikační autorita organizace, která běží na verzi Enterprise systému Windows Server 2008 R2 nebo novějšího. Samostatná certifikační autorita není podporovaná. Návod, jak nastavit certifikační autoritu, najdete v tématu [Instalace certifikační autority](http://technet.microsoft.com/library/jj125375.aspx).
...
Informace o certifikátech pro službu WAP najdete v části **Plánování certifikátů** v tématu [Plánování publikování aplikací pomocí Proxy webových aplikací](https://technet.microsoft.com/library/dn383650.aspx). Obecné informace o serverech WAP najdete v tématu věnovaném [práci s Proxy webových aplikací](http://technet.microsoft.com/library/dn584113.aspx)
...
>   [!IMPORTANT]
    > Do pole Zásady použití (na 4. snímku) zadejte jenom požadované zásady použití. Správnost zadaných voleb zkontrolujte se správci zabezpečení.
...
2.  Po dokončení průvodce upravte následující klíč registru na serveru NDES:
    ...
    |Účel šablony certifikátu (na kartě Vyřízení žádosti)|Upravovaná hodnota registru|Hodnota zobrazená v konzole správce Intune pro profil SCEP|
    |--------------------------------------------------------------|--------------------------|------------------------------------------------------------------------------------------------------------|
...
2.  Na serveru NDES vyžádejte a nainstalujte certifikát pro **ověřování klientů** z vaší interní certifikační autority nebo z veřejné certifikační autority. Může to být stejný certifikát jako ověřovací certifikát serverů, pokud má tento certifikát obě schopnosti.
    ...
    **Název subjektu** – musí být stejný jako název DNS serveru, na který certifikát instalujete (server NDES).
