...
5.  **Informujte uživatele, jak můžou svá zařízení zaregistrovat, aby získali přístup k firemním prostředkům.**
    ...
    Postup registrace koncových uživatelů najdete v tématech [Registrace zařízení se systémem iOS do Intune](../enduser/enroll-your-device-in-intune-ios.md) a [Registrace zařízení s Mac OS X v Intune](../enduser/enroll-your-device-in-intune-mac-os-x.md). Proces registrace uživatele informuje, co můžou očekávat a co správci IT na jejich zařízeních uvidí a neuvidí.
