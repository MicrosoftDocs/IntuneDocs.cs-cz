...
description: "Správa mobilních zařízení Microsoft Intune (MDM) využívá registraci pro zajištění správy zařízení a povolení přístupu k prostředkům."
keywords: 
author: NathBarn
manager: arob98
ms.date: 07/18/2016
...
[Přidružení uživatele](enroll-corporate-owned-ios-devices-in-microsoft-intune.md#enrollment-of-company-owned-ios-devices-with-user-affinity) ([Zpět k tabulce](#overview-of-device-enrollment-methods))
