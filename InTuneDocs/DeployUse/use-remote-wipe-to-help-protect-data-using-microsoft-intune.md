...
|Spravované aplikace Google Play|Odeberou se data aplikací. Aplikace se neodebere. Data chráněná šifrováním MAM mimo aplikaci (karta SD atd.) zůstávají šifrovaná, ale neodeberou se.|Odeberou se data aplikací. Aplikace se neodebere. Data chráněná šifrováním MAM mimo aplikaci (karta SD atd.) zůstávají šifrovaná, ale neodeberou se.|
|Spravované obchodní aplikace|Odeberou se data aplikací. Aplikace se neodebere. Data chráněná šifrováním MAM mimo aplikaci (karta SD atd.) zůstávají šifrovaná, ale neodeberou se.|Odeberou se data aplikací. Aplikace se neodebere. Data chráněná šifrováním MAM mimo aplikaci (karta SD atd.) zůstávají šifrovaná, ale neodeberou se.|
...
|Zrušení služby Azure Active Directory (AAD)|Ne|Ne|Záznam AAD se odebere|Záznam AAD se odebere|
...
-   Soubory a složky zašifrované systémem souborů EFS. Další informace najdete v tématu [Osvědčené postupy pro systém souborů EFS](http://support.microsoft.com/kb/223316)..
