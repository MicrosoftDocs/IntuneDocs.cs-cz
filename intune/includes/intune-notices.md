...
Když tuto změnu je nasazen v březnu, profily registrace v Intune na portálu Azure portal se aktualizují tak, aby můžete určit, jak ověřovat zařízení, a pokud se zobrazí v aplikaci portál společnosti. Bude Vylepšený pracovní postup registrace zařízení s Iosem pomocí výše uvedených metod. Poznámka:
