...
2. Vyberte **Uživatelé** > **aktivní uživatelé** > a vyberte právě vytvořeného uživatele.
...
Pokud tento uživatel již nepotřebujete, můžete uživatele odstranit tak, že přejdete do [centra pro správu Microsoft 365](http://go.microsoft.com/fwlink/p/?LinkId=698854) a zvolíte možnost **Uživatelé** > **aktivní uživatelé** > *vybrat možnost uživatel v seznamu* > **Odstranit** **uživatel odstraní**změny potvrďte zavřít. >  >  > 
