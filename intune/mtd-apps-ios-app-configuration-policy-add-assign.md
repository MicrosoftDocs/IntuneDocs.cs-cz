...
- **iOS**
  - Přečtěte si pokyny pro [přidávání aplikací z iOS Storu do Microsoft Intune](store-apps-ios.md). Použijte tento [Lookout for Work iOS app storu URL](https://itunes.apple.com/us/app/lookout-for-work/id997193468?mt=8) na **krok 11** pro **adresu URL obchodu**.
...
- **Aplikace Lookout for Work mimo obchod App Store společnosti Apple**  
  ...
  - **Přidání souboru IPA aplikace Lookout for Work**
    ...
    - Nahrát opětovně podepsaný soubor .ipa podle popisu v [přidat obchodní aplikace pro iOS v Intune](lob-apps-ios.md) článku. Kromě toho je potřeba nastavit jako minimální verzi operačního systému iOS 8.0 nebo novější.
...
- **iOS**
  - Přečtěte si pokyny pro [přidávání aplikací z iOS Storu do Microsoft Intune](store-apps-ios.md). Použijte tento [URL obchodu s aplikacemi aplikaci SEP Mobile](https://itunes.apple.com/us/app/skycure/id695620821?mt=8) na **krok 11** pro **adresu URL obchodu**.
...
- **iOS**
  - Přečtěte si pokyny pro [přidávání aplikací z iOS Storu do Microsoft Intune](store-apps-ios.md). Použijte tento [URL obchodu s aplikacemi Check Point SandBlast Mobile](https://apps.apple.com/us/app/sandblast-mobile-protect/id1006390797) na **krok 11** pro **adresu URL obchodu**.  
...
- **iOS**
  - Přečtěte si pokyny pro [přidávání aplikací z iOS Storu do Microsoft Intune](store-apps-ios.md). Použijte tento [URL obchodu s aplikacemi Zimperium](https://itunes.apple.com/us/app/zimperium-zips/id1030924459?mt=8) na **krok 11** pro **adresu URL obchodu**.  
...
- **iOS**
  - Přečtěte si pokyny pro [přidávání aplikací z iOS Storu do Microsoft Intune](store-apps-ios.md). Použijte tento [URL obchodu s aplikacemi Pradeo](https://itunes.apple.com/us/app/pradeo-agent/id547979360?mt=8) na **krok 11** pro **adresu URL obchodu**.
...
- **iOS**
  - Přečtěte si pokyny pro [přidávání aplikací z iOS Storu do Microsoft Intune](store-apps-ios.md). Použijte tento [URL obchodu s aplikacemi ActiveShield](https://itunes.apple.com/us/app/activeshield/id980234260?mt=8&uo=4) na **krok 11** pro **adresu URL obchodu**.
...
- **Stáhněte si** soubor zásad Konfigurace aplikace iOS: 
