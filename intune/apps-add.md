...
Uživatelé aplikací a zařízení ve vaší společnosti (zaměstnanci vaší společnosti) mohou mít na aplikace několik požadavků. Než aplikace přidáte do Intune a zpřístupníte je zaměstnancům, musíte vyhodnotit a pochopit několik základních informací o aplikacích. Je nutné, abyste rozuměli různým typům aplikací, které jsou pro Intune dostupné. Je nutné, abyste vyhodnotili požadavky na aplikace, jako jsou potřebné platformy a možnosti vyžadované vašimi zaměstnanci. Musíte také určit, jestli budete používat Intune ke správě zařízení (včetně aplikací), nebo jestli má Intune spravovat aplikace bez správy zařízení. Musíte určit, kteří pracovníci budou různé aplikace a různé možnosti potřebovat. Informace uvedené v tomto článku vám pomůžou začít.

## <a name="app-types-in-microsoft-intune"></a>Typy aplikací v Microsoft Intune

Intune podporuje širokou škálu různých typů aplikací. Dostupné možnosti se pro jednotlivé typy aplikací liší. Intune umožňuje přidat a přiřadit tyto typy aplikací:

| **Typy aplikací**                                     | **Instalace**                                                                  | **Aktualizace**                       |
|------------------------------------------ |----------------------------------------------------------------------------   |---------------------------    |
| Aplikace pocházející ze Storu (aplikace ze Storu)          | Intune nainstaluje aplikaci na zařízení.                                       | Aktualizace aplikací jsou automatické.     |
...
| Aplikace, které jsou integrované (integrované aplikace)    | Intune nainstaluje aplikaci na zařízení.                                       | Aktualizace aplikací jsou automatické.     |
...
Následující tabulka obsahuje konkrétní typy aplikací a popis, jak je můžete přidat v okně **Přidat aplikaci** v Microsoft Intune:

| **Konkrétní typ aplikace**                         | **Obecný typ**             | **Konkrétní postupy aplikace**                                                                                                                                                 |
|---------------------------------------------|------------------------------|-------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| Aplikace pro Android Store                        | Aplikace ze Storu                  | Jako **typ aplikace** vyberte **Android** a zadejte adresu URL obchodu Google Play pro aplikaci.                                                                                       |
| Aplikace pro iOS Store                            | Aplikace ze Storu                  | Jako **typ aplikace** vyberte **iOS**, vyhledejte aplikaci a vyberte aplikaci v Intune.                                                                                     |
| Aplikace pro Windows Phone 8.1 Store              | Aplikace ze Storu                  | Jako **typ aplikace** vyberte **Windows Phone 8.1** a zadejte adresu URL obchodu Microsoft Store pro aplikaci.                                                                               |
| Aplikace pro Microsoft Store                      | Aplikace ze Storu                  | Jako **typ aplikace** vyberte **Windows** a zadejte adresu URL obchodu Microsoft Store pro aplikaci.                                                                                         |
| Aplikace pro Android for Work                     | Aplikace ze Storu                  | Vyhledejte a schvalte aplikaci pro Android for Work z obchodu Google Play for Work.                                                                                        |
| Aplikace Office 365 pro Windows 10            | Aplikace ze Storu (Office 365)     | V části **Sada Office 365** vyberte jako **typ aplikace** možnost **Windows 10**, potom vyberte aplikaci Office 365, kterou chcete nainstalovat.                                                |
| Aplikace Office 365 pro macOS                 | Aplikace ze Storu (Office 365)     | V části **Sada Office 365** vyberte jako **typ aplikace** možnost **macOS** a potom vyberte sadu aplikací Office 365.                                                                     |
| Obchodní aplikace (LOB) pro Android       | Obchodní aplikace (LOB) | Jako **typ aplikace** vyberte **Obchodní** aplikaci, vyberte **Soubor balíčku aplikace** a pak zadejte instalační soubor pro Android s příponou **.apk**.                    |
| Obchodní aplikace (LOB) pro iOS           | Obchodní aplikace (LOB) | Jako **typ aplikace** vyberte **Obchodní** aplikaci, vyberte **Soubor balíčku aplikace** a pak zadejte instalační soubor pro iOS s příponou **.ipa**.                        |
| Obchodní aplikace (LOB) pro Windows Phone | Obchodní aplikace (LOB) | Jako **typ aplikace** vyberte **Obchodní** aplikaci, vyberte **Soubor balíčku aplikace** a pak zadejte instalační soubor pro iOS s příponou **.xap**.                        |
| Obchodní aplikace (LOB) pro Windows       | Obchodní aplikace (LOB) | Jako typ aplikace vyberte Obchodní aplikaci, vyberte Soubor balíčku aplikace a pak zadejte instalační soubor pro iOS s příponou **.msi**, **.appx** nebo **.appxbundle**. |
...
| Webové aplikace                                  | Webová aplikace                    | Jako **typ aplikace** vyberte **Webový odkaz** a zadejte platnou adresu URL odkazující na webovou aplikaci.                                                                                        |

   
Aplikaci můžete v Microsoft Intune přidat výběrem možností **Mobilní aplikace** > **Aplikace** > **Přidat**. Zobrazí se okno **Přidat aplikaci** a umožní vám vybrat **Typ aplikace**. 
...
- **Aplikace ze Storu** – aplikace pro Store je aplikace, která je nahraná v Microsoft Storu, obchodu pro iOS nebo Android. Poskytovatel aplikace pro Store udržuje a poskytuje aktualizace aplikace. Aplikaci si vyberete v seznamu ve Storu a přidáte ji pomocí Intune jako aplikaci dostupnou pro vaše uživatele.
...
- **Microsoft Store pro firmy (Windows 10)** – Microsoft Store pro firmy je místo, kde můžete najít a zakoupit aplikace pro svou organizaci, a to jednotlivě i hromadně. Pokud Store propojíte s Microsoft Intune, můžete hromadně zakoupené aplikace spravovat z Azure Portalu. Další informace najdete v článku [Správa aplikací zakoupených v Microsoft Storu pro firmy](windows-store-for-business.md).
...
4. V úloze **Mobilní aplikace** zvolte v části **Nastavení** možnost **Kategorie aplikací**. 
