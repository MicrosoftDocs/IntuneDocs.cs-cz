...
- [**Windows Hello pro firmy nastavení**](windows-hello.md). Nastavení Windows Hello pro firmy je alternativní metoda přihlašování, která umožňuje uživatelům používat k přihlášení *gesto*, třeba otisk prstu nebo Windows Hello, takže nemusí zadávat heslo.
...
- Další informace o [správy zařízení v Microsoft Intune](device-management.md)
