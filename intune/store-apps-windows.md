---
title: "Přidání aplikací z Windows Storu do Microsoft Intune"
titleSuffix: 
...
---
# <a name="how-to-add-windows-store-apps-to-microsoft-intune"></a>Přidání aplikací z Windows Storu do Microsoft Intune
...
5. Nad seznamem zvolte **Přidat**.
6. Z dostupných typů **Aplikace pro Store** vyberte možnost **Windows**.
7. Zvolte **Informace o aplikaci** a nakonfigurujte informace o aplikaci.
8. V okně **Informace o aplikaci** nakonfigurujte následující informace: Některé hodnoty v tomto podokně můžou být v závislosti na zvolené aplikaci automaticky vyplněné:
    ...
    - **Kategorie** (volitelné) – vyberte jednu nebo několik kategorií aplikací, nebo kategorii, kterou jste vytvořili. Přidáním těchto informací dosáhnete toho, že uživatelé aplikaci při procházení portálu společnosti snadněji najdou.
...
1. Po zadání všech potřebných informací o aplikaci klikněte na **OK**.
2. V okně **Přidat aplikaci** klikněte na **Přidat**.
...
5. Než nahrajete aplikaci Portál společnosti do Intune, vytvořte složku (například C:&#92;Portál společnosti) s balíčky strukturovanými následovně:
  ...
  - Umístěte devět balíčků závislostí do složky Závislosti. Pokud nebudou závislosti umístěné v tomto formátu, Intune je při nahrávání balíčku nerozpozná a nenahraje a nahrávání se nezdaří s následující chybou: 
