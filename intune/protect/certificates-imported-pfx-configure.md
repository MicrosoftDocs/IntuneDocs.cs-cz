...
2. Přejít na `.\Intune-Resource-Access-develop\src\PFXImportPowershell\` a otevřete projekt pomocí sady Visual Studio pomocí souboru **PFXImportPS. sln**.
...
5. Proces sestavení vytvoří novou složku s modulem PowerShellu na `.\Intune-Resource-Access-develop\src\PFXImportPowershell\PFXImportPS\bin\Release`.
