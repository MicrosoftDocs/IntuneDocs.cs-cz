...
V této části se zmiňují Správce zařízení (DA) i registrace Samsung KNOX. Další informace najdete v tématu [registrace Správce zařízení s Androidem](android-enroll-device-administrator.md) a [Automatická registrace zařízení s Androidem pomocí zápisu mobilních zařízení Samsung pro Samsung](android-samsung-knox-mobile-enroll.md). 
