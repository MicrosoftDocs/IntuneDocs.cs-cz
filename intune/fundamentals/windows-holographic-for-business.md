...
- **[Synchronizace zařízení za účelem získání nejnovějších zásad a akcí](../remote-actions/device-sync.md)** : Akce **Synchronizovat** vynutí okamžité připojení zařízení k Intune. Jakmile se zařízení připojí, začne okamžitě přijímat veškeré čekající akce nebo zásady, které mu byly přiřazeny. Tato funkce vám může pomoct ověřit přiřazené zásady nebo s těmito zásadami vyřešit potíže, aniž byste čekali na další naplánované vrácení se změnami.
...
### <a name="custom-device-settingsconfigurationcustom-settings-windows-holographicmd"></a>[Vlastní nastavení zařízení](../configuration/custom-settings-windows-holographic.md)
...
### <a name="configure-kiosk-modeconfigurationkiosk-settings-holographicmd"></a>[Konfigurace beznabídkového režimu](../configuration/kiosk-settings-holographic.md)
...
### <a name="device-restrictionsconfigurationdevice-restrictions-windows-holographicmd"></a>[Omezení zařízení](../configuration/device-restrictions-windows-holographic.md)
...
### <a name="configure-vpnconfigurationvpn-settings-configuremd"></a>[Konfigurace VPN](../configuration/vpn-settings-configure.md)
...
### <a name="configure-wi-ficonfigurationwi-fi-settings-configuremd"></a>[Konfigurace Wi-Fi](../configuration/wi-fi-settings-configure.md)
