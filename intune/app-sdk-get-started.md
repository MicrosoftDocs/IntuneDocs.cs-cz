...
_**Musíte**_ aplikaci nejdřív zaregistrovat ve službě Microsoft Intune a odsouhlasit podmínky registrace. Správci IT potom můžou u spravované aplikace použít zásady ochrany aplikací. Ta pak bude uvedená jako partnerská aplikace Intune.
...
* **Testovací účet Microsoft Intune**: K testování vašich aplikací spravovaných v Intune s funkcemi ochrany aplikací Intune, budete potřebovat účet Microsoft Intune.
    ...
    * Pokud testujete aplikaci na mobilním zařízení pomocí účtu koncového uživatele, ujistěte se, že jste udělili tento účet licenci Intune na webu portálu pro správu Office po přihlášení pomocí účtu správce, naleznete v tématu [licence na Microsoft Intune přiřaďte](https://docs.microsoft.com/en-ca/intune/licenses-assign).
