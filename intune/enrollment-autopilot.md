...
4. Vyberte **Registrace zařízení s Windows** a v části **Program Windows AutoPilot Deployment** zvolte **Zařízení**.
...
2. Zvolte **Všechny služby** > **Intune**. Intune se nachází v části **Monitorování a správa**.
3. V **Intune** zvolte **Registrace zařízení**.
4. Vyberte **Registrace zařízení s Windows** a v části **Program Windows AutoPilot Deployment** zvolte **Profily nasazení**.
5. Vyberte **Vytvořit profil** a zvolte název a volitelný popis.
6. Pro **Připojit k Azure AD jako** vyberte **Připojeno k Azure AD**.
7. Pro **Software spouštěný při prvním zapnutí zařízení** nakonfigurujte následující možnosti a pak klikněte na **Uložit**:
...
6. Kliknutím na **Vytvořit** vytvořte profil. Profil nasazení AutoPilotu je teď možné přiřazovat zařízením.
...
3. V **Intune** zvolte **Registrace zařízení**.
4. Vyberte **Registrace zařízení s Windows** a v části **Program Windows AutoPilot Deployment** zvolte **Zařízení**.
5. Vyberte zařízení, kterým chcete profil nasazení přiřadit. Zařízení bez přiřazeného profilu snadno najdete pomocí filtrování ve sloupci **Stav profilu**.
