...
> [!NOTE]
> Powershellový skript se spustí v části oprávnění správce (ve výchozím nastavení) Pokud skript je nastavena na uživatelský kontext a koncový uživatel na zařízení má oprávnění správce.
