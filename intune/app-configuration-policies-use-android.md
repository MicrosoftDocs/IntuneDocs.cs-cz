...
1. V [Intune](https://go.microsoft.com/fwlink/?linkid=2090973)vyberte **klientské aplikace** >  >  **zásady konfigurace aplikace** **Přidat**.
...
2. Pro každý klíč a hodnotu v konfiguraci nastavte:
    ...
    - **Hodnota konfigurace**: Hodnota konfigurace Pokud pro **typ hodnoty**vyberete možnost proměnná nebo certifikát, vyberte ze seznamu proměnných nebo profilů certifikátů. Pokud zvolíte certifikát, pak se za běhu naplní alias certifikátu nasazeného do zařízení.
