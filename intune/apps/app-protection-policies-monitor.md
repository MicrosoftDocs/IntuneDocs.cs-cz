...
![Dlaždice souhrnu podokna Správa mobilních aplikací Intune](./media/app-protection-policies-monitor/app-protection-user-status-summary.png)
...
- **Uživatelé označení příznakem:** Počet uživatelů, kteří mají problémy. Zařízení s jailbreakem (iOS) a rootem (Android) se hlásí v části **Uživatelé označení příznakem**. Uživatelé se zařízeními, která jsou označená kontrolou ověření zařízení Google SafetyNet (Pokud je zapnutá správcem IT), jsou uvedená tady. 
