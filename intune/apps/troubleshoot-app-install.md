...
> [!NOTE]
> Informace o chybách při instalaci konkrétní aplikace najdete v tématu [Reference k instalaci aplikace Intune](~/apps/app-install-error-codes.md).
