...
ms.locfileid: "67883232"
---
# <a name="quickstart-try-microsoft-intune-for-free"></a>Rychlý Start Vyzkoušet Microsoft Intune zdarma 
...
2. Vytvořte si účet. Použijte k tomu název společnosti, za který přidáte **.onmicrosoft.com**. 
    ...
    ![Snímek obrazovky zkušebního účtu Intune – nový proces přihlašovacích údajů](./media/account-sign-up-site-user-id.png)
...
3. Zadejte název vlastní domény. Pak vyberte **Další**.
   ...
   ![Snímek obrazovky centra pro správu Microsoft 365 – přidat doménu](./media/domain-custom-add.png)
...
4. Ověřte, že jste vlastníkem domény, kterou jste zadali v předchozím kroku. 
   ...
   ![Snímek obrazovky centra pro správu Microsoft 365 – ověření domény](./media/domain-custom-verify.png)
...
> [Rychlý Start Vytvořit uživatele a přiřadit mu licenci](quickstart-create-user.md)
