...
Zásady dodržování předpisů se vytvářejí pro jednotlivé platformy.  Zásady dodržování předpisů můžete vytvořit na portálu Azure Portal. Pokud se chcete o zásadách dodržování předpisů dozvědět více, přečtěte si článek [Co je dodržování předpisů zařízením](device-compliance.md). Požadavky, kterým je potřeba vyhovět před vytvořením zásad dodržování předpisů, najdete v článku [Začínáme s dodržováním předpisů zařízeními](device-compliance-get-started.md).
...
3. Zvolte **Požadavky na dodržování předpisů** a zadejte nastavení pro **Zabezpečení**, **Stav zařízení** a **Vlastnosti zařízení**. Po dokončení klikněte na **OK**.
...
- **Vyžadovat, aby byla povolena Ochrana zařízení před internetovými útoky:** Toto nastavení použijte, pokud chcete jako podmínku dodržování předpisů použít vyhodnocování rizika z řešení Lookout MTP. Vyberte jednu z následujících úrovní hrozeb jako maximální povolenou:
  ...
  - **Střední:** Zařízení je vyhodnoceno jako dodržující předpisy, pokud se v něm přítomné hrozby pohybují na střední nebo nízké úrovni. Pokud se v zařízení zjistí hrozby vysoké úrovně, vyhodnotí se jako nedodržující předpisy.
