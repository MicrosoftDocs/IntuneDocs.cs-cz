...
|    Collection                          |    Změnit     |    Další informace                                                                                                                                                                                                                                                                                                                                                                 |
|----------------------------------------|---------------|-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
...
|    workPlaceJoinStateTypes             |    Odebrané    |    Místo toho použijte [](intune-data-warehouse-collections.md#devices) [](intune-data-warehouse-collections.md#devicepropertyhistories) vlastnost v devicePropertyHistories kolekcích `azureAdRegistered` zařízení.                                                                                                                                                                                                             |
