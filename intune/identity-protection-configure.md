...
3. Zadejte tyto vlastnosti:
    ...
    - **Typ profilu**: Vyberte možnost **ochrana identity**.
...
Profil se vytvoří a zobrazí se v seznamu profily. V dalším kroku [přiřaďte](device-profile-assign.md) tento profil skupinám uživatelů a zařízení, aby vyhovovaly vašim potřebám.
