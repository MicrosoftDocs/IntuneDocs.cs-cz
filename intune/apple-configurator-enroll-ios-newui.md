...
description: "Přečtěte si, jak jde pomocí Apple Configuratoru registrovat zařízení s iOSem vlastněná společností s využitím Průvodce nastavením (nové uživatelské rozhraní).\""
keywords: 
author: ErikjeMS
ms.author: erikje
manager: dougeby
