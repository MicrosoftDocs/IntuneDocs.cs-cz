...
- **Ovladače Windows**  
  **Výchozí**:  Allow  
  Web Windows Update CSP: [Aktualizovat/ExcludeWUDriversInQualityUpdate](https://docs.microsoft.com/windows/client-management/mdm/policy-csp-update#update-excludewudriversinqualityupdate)  
...
- **Doba odložení aktualizace kvality (ve dnech)**  
  **Výchozí**: 0  
  Web Windows Update CSP: [Aktualizovat/DeferQualityUpdatesPeriodInDays](https://docs.microsoft.com/windows/client-management/mdm/policy-csp-update#update-deferqualityupdatesperiodindays)  
...
- **Nastavit období odinstalace aktualizací funkcí (2 – 60 dní)**  
  **Výchozí**: 10  
  Web Windows Update CSP: [Aktualizovat/ConfigureFeatureUpdateUninstallPeriod](https://docs.microsoft.com/windows/client-management/mdm/policy-csp-update#update-configurefeatureupdateuninstallperiod)  
...
- **Chování automatické aktualizace**  
  **Výchozí**: Automaticky nainstalovat v době údržby  
  Web Windows Update CSP: [Aktualizovat/AllowAutoUpdate](https://docs.microsoft.com/windows/client-management/mdm/policy-csp-update#update-allowautoupdate)  
  ...
  - Automaticky **nainstalovat v době údržby** – aktualizace se automaticky stahují a pak se během automatické údržby instalují, když se zařízení nepoužívá nebo neběží při napájení z baterie. Po restartování počítače se uživatelům zobrazí výzva k restartování po dobu až sedmi dnů a pak se restartování vynutí.  
    ...
    - **Začátek aktivních hodin** – zadejte počáteční čas pro potlačení restartování z důvodu instalace aktualizací.  
      **Výchozí**: 8 DOP.  
      Web Windows Update CSP: [Aktualizovat/ActiveHoursStart](https://docs.microsoft.com/windows/client-management/mdm/policy-csp-update#update-activehoursstart)  
  
    - **Aktivní hodiny končí** – zadejte čas ukončení pro potlačení restartování kvůli instalaci aktualizací.  
      **Výchozí**: 5 ODP.  
      Web Windows Update CSP: [Aktualizovat/ActiveHoursEnd](https://docs.microsoft.com/windows/client-management/mdm/policy-csp-update#update-activehoursend)  
...
- **Restartovat kontroly**  
  **Výchozí**: Allow  
  Web Windows Update CSP: [Aktualizovat/SetEDURestart](https://docs.microsoft.com/windows/client-management/mdm/policy-csp-update#update-setedurestart)  
...
- **Vyžadovat schválení uživatele pro restartování mimo pracovní dobu**  
  **Výchozí**: Není nakonfigurováno  
  Web Windows Update CSP: [Aktualizovat/AutoRestartRequiredNotificationDismissal](https://docs.microsoft.com/windows/client-management/mdm/policy-csp-update#update-autorestartrequirednotificationdismissal)
...
- **Připomenout uživatele před vyžadováním automatického restartování s připomenutím přeskočit (hodiny)**  
  **Výchozí**: 4  
  Web Windows Update CSP: [Aktualizovat/ScheduleRestartWarning](https://docs.microsoft.com/windows/client-management/mdm/policy-csp-update#update-schedulerestartwarning)  
...
- **Změna úrovně oznámení aktualizace**  
  **Výchozí**: Použít výchozí oznámení web Windows Update  
  Web Windows Update CSP: [Aktualizovat/UpdateNotificationLevel](https://docs.microsoft.com/windows/client-management/mdm/policy-csp-update#update-updatenotificationlevel)
...
- **Povolení restartování uživatelem (při restartování)**  
  **Výchozí**: Není nakonfigurováno  
  ...
  - **Převod uživatelů na restartování po automatickém restartování (dny)**  
    **Výchozí**: Nenakonfigurováno web Windows Update CSP: [Update/EngagedRestartTransitionSchedule](https://docs.microsoft.com/windows/client-management/mdm/policy-csp-update#update-engagedrestarttransitionschedule)  
  ...
  - **Nastavit konečný termín pro čekání na restartování (dny)**  
    **Výchozí**: Není nakonfigurováno  
    Web Windows Update CSP: [Aktualizovat/EngagedRestartDeadline](https://docs.microsoft.com/windows/client-management/mdm/policy-csp-update#update-engagedrestartdeadline)  
...
- **Použít nastavení termínu**  
  **Výchozí**: Není nakonfigurováno  
  > [!IMPORTANT]  
  > Od aktualizace srpen pro Intune doporučujeme použít následující nastavení termínu, které nahrazuje nastavení provedených restartování. Intune bude v budoucí aktualizaci Intune zastaralá [o podporu pro nastavení *restartování* ](whats-new.md#plan-for-change-new-windows-updates-settings-in-intune-) .  
  ...
  - **Konečný termín pro aktualizace funkcí**  
    **Výchozí**: 7  
    Web Windows Update CSP: [Aktualizovat/ConfigureDeadlineForFeatureUpdates](https://docs.microsoft.com/windows/client-management/mdm/policy-csp-update#update-configuredeadlineforfeatureupdates)  
  ...
  - **Konečný termín pro aktualizace kvality**  
    **Výchozí**: 7  
    Web Windows Update CSP: [Aktualizovat/ConfigureDeadlineForQualityUpdates](https://docs.microsoft.com/windows/client-management/mdm/policy-csp-update#update-configuredeadlineforqualityupdates)

    Určuje počet dní, po které má uživatel k automatické instalaci aktualizací kvality na svých zařízeních (2-30).

  - **Období odkladu**  
    **Výchozí**: 2 web Windows Update CSP: [Aktualizovat/ConfigureDeadlineGracePeriod]( https://docs.microsoft.com/windows/client-management/mdm/policy-csp-update#update-configuredeadlinegraceperiod)
  ...
  - **Automatický restart před konečným termínem**  
    **Výchozí**:  Ano web Windows Update CSP: [Aktualizovat/ConfigureDeadlineNoAutoReboot](https://docs.microsoft.com/windows/client-management/mdm/policy-csp-update#update-configuredeadlinenoautoreboot)
