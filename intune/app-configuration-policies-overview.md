...
> 
> ![Snímek obrazovky nakonfigurované aplikace](./media/app-configuration-policy-overview/configured-app.png)
>
...
![Typ registrace zařízení](./media/app-configuration-policy-overview/device-enrollment-type.png)
...
Zásady konfigurace aplikací můžete ověřit pomocí následujících tří metod:
   ...
   3. Na portálu Intune. V části **monitorování** zásad může být zajištěn příslušný stav:
      ...
      ![První snímek stavu instalace zařízení](./media/app-configuration-policy-overview/device-install-status-1.png)
