...
- **ID týmu** (pouze přihlašovací údaje): zadejte identifikátor týmu rozšíření aplikace jednotného přihlašování. Identifikátor týmu je alfanumerický řetězec (čísel a písmen) 10 znaků generovaný společností Apple, například `ABCDE12345`. 
