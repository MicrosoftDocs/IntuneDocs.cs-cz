...
> [!NOTE]
> Pokud vypršela platnost tokenu, nebude se v **zápisu zařízení**zobrazovat profil, který je k němu přidružený  > **registrace Androidu** > **vyhrazená zařízení ve vlastnictví firmy**. Pokud chcete zobrazit všechny profily přidružené k aktivním i neaktivním tokenům, klikněte na **Filtr** a zaškrtněte políčka u možnosti aktivní i neaktivní stavy zásad. 
