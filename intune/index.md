...
description: "Jak používat Microsoft Intune"
                            ...
                            <div class="cardSize">
                                <div class="cardPadding">
                                    <div class="card">
                                        ...
                                        <div class="cardText">
                                            <h3>Intune na portálu Azure Portal</h3>
                                            <p>Microsoft Intune je k dispozici na portálu Azure Portal. Přečtěte si informace o správě zařízení a aplikací na novém portálu. </p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="cardSize">
                                <div class="cardPadding">
                                    <div class="card">
                                        ...
                                        <div class="cardText">
                                            <h3>Co je Intune for Education?</h3>
                                            <p>Podívejte se, jak je možné provádět každodenní úkoly pomocí zařízení v učebnách.</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="cardSize">
                                <div class="cardPadding">
                                    <div class="card">
                                        ...
                                        <div class="cardText">
                                            <h3>Začínáme s Intune</h3>
                                            <p>Naučte se základy: Vytvořte skupinu a uživatele. Zaregistrujte zařízení. Přiřaďte zásady a aplikace.</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="cardSize">
                                <div class="cardPadding">
                                    <div class="card">
                                        ...
                                        <div class="cardText">
                                            <h3>150 a více licencí? Využijte výhod FastTracku</h3>
                            ...
                            <div class="cardSize">
                                <div class="cardPadding">
                                    <div class="card">
                                        ...
                                        <div class="cardText">
                                            <h3>Kde v Azure najdu svoje funkce Intune?</h3>
                                            <p>Pokud jste obeznámeni s Intune v klasické konzole, pomůže vám tento článek vyhledat požadovanou funkci v Intune na Azure.</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
...
<!--                        <li>
                        ...
                        <li class="fullSpan">
                            <div class="container">
                                <h3>Viz <a href="/intune/what-is-intune">kompletní dokumentace k Intune</a>.</h3>
                            </div>
                        </li>
                    </ul>
                </li>
...
<!--                        <li>
                        ...
                        <li class="fullSpan">
                            <div class="container">
                                <h3>Viz <a href="/intune/what-is-intune">kompletní úvodní dokumentace</a>.</h3>
                            </div>
                        </li>
                    </ul>
                </li>
                            ...
                            <div class="cardSize">
                                <div class="cardPadding">
                                    <div class="card">
                                        ...
                                        <div class="cardText">
                                            <h3>Podporovaná zařízení a prohlížeče</h3>
                                            <p>Přečtěte si podrobnosti o zařízeních a prohlížečích podporovaných službou.</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="cardSize">
                                <div class="cardPadding">
                                    <div class="card">
                                        ...
                                        <div class="cardText">
                                            <h3>Průvodce plánováním, návrhem a implementací nasazení</h3>
                                            <p>Připravte plán nasazení, vytvořte návrh, implementujte Intune a proveďte nasazení v ostrém provozu.</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="cardSize">
                                <div class="cardPadding">
                                    <div class="card">
                                        ...
                                        <div class="cardText">
                                            <h3>Průvodce migrací</h3>
                                            <p>Seznamte se s různými detaily migrace od jiného poskytovatele MDM do Intune.</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
...
<!--                        <li>
                        ...
                        <li class="fullSpan">
                            <div class="container">
                                <h3>Viz <a href="/intune-classic/plan-design/introduction">kompletní dokumentace k plánování nasazení</a>.</h3>
                            </div>
                        </li>
                    </ul>
                </li>
...
<!--                        <li>
                        ...
                        <li class="fullSpan">
                            <div class="container">
                                <h3>Viz <a href="/intune/device-enrollment">kompletní dokumentace postupů</a>.</h3>
                            </div>
                        </li>
                    </ul>
                </li>
                <li>
                    ...
                    <ul id="manage-troubleshoot" class="cardsC">
                                ...
                                <div class="cardPadding">
                                    <div class="card">
                                        ...
                                        <div class="cardText">
                                            ...
                                            <p>Přečtěte si o známých problémech v Intune.</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <li class="fullSpan">
                            <div class="container">
                                <h3>Viz <a href="/intune-classic/troubleshoot/general-troubleshooting-tips-for-microsoft-intune">kompletní dokumentace k řešení potíží</a>.</h3>
                            </div>
                        </li>
                    </ul>
                </li>
            ...
            <ul id="sdkstools">
                <li>
                    ...
                    <ul id="sdkstools-all" class="cardsC">                       
                        ...
                        <li class="fullSpan">
                            <div class="container">
                                <h3>Chcete se podívat na přehled veškeré dokumentace? Viz <a href="/intune-classic/understand-explore/introduction-to-microsoft-intune">kompletní dokumentace k Intune</a>.</h3>
                            </div>
                        </li>
                    </ul>
                </li>
