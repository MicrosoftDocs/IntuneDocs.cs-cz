...
|Chybová zpráva|Co vyzkoušet|
|---|---|
|**Chyba při aktivaci zařízení Samsung Knox** – nepodařilo se aktivovat licenci Samsung KNOX. Může to být proto, že je zapnutý režim úspory napájení. Vypněte režim úspory napájení v nastavení zařízení a zkuste to znovu. |Zařízení nemusí mít správně nastavené napájení, aby fungovalo s prostředky společnosti. Další informace o tomto nastavení najdete v tématu [režim úspory energie](power-saving-mode-android.md).|  
