...
### [Instalace aplikací z aplikace Portál společnosti](install-apps-cpapp-windows.md) 
### [Vzdálené uzamčení zařízení z aplikace Portál společnosti](remote-lock-your-device-cp-app.md)   
### [Přejmenování zařízení z aplikace Portál společnosti](rename-your-device-cpapp.md) 
